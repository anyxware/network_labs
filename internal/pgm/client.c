/*
    install libpgm
    move headers into /usr/include/pgm/
    gcc -c client.c -o client.o; gcc -o client client.o -lpgm; sudo ./client -n "192.168.0.105;239.0.0.1" -l -p 8000 lol; rm client.o client
*/
...
/* parse program arguments */
	...
	if (create_sock())
	{
		while (optind < argc) {
		    ...
		    //const int status = pgm_send (sock, buffer, 8192, NULL);
